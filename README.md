## COMANDI PER AVVIO DELLA SIMULAZIONE DEL PROGETTO DI ROBOTICA

* % conda activate pddlstream
* % cd pddlstream

## AVVIO DEL PRIMO PROBLEMA SENZA UTILIZZO RRT
* % python -m examples.continuous_tamp.run -p tight
* % python -m examples.continuous_tamp.run -p new_problem 

## AVVIO DEL SECONDO PROBLEMA CHE UTILIZZA RRT
* % python -m examples.continuous_tamp_RRT.run -p tight
* % python -m examples.continuous_tamp_RRT.run -p new_problem
